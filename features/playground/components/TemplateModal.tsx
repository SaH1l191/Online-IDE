...
const TemplateSelectionModal = ({
  ...
  const [projectName, setProjectName] = useState(generatePlaygroundName());





  //filter the tags and a particular template 
  ...
  //set selected template by its id 
  ...
  //after clicking on template create project 
        ...
        {step === "select" ? (
          ...
          <>
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              {/*   {/* Search templates and tags mapping  */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div key={template.id} className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02] ${selectedTemplate === template.id
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="flex flex-col">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              {/* icon color next to the template name ie React,express */}
                    ...
                    // no templates found while searching for template 
          ...
          // step 2 
          <>
            {/* header of the selected project */}
            <DialogHeader>
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              {/* selected template feature mapping  */}
