  ...
  return (
    <Sidebar variant="inset" collapsible="icon" className="border-1 border-r">
      ...
      <SidebarContent>
        ...
        {/* group 1 => contains home and dashboard button with active css class  */}
        <SidebarGroup>
          <SidebarMenu>
            <SidebarMenuItem>
        ...
        {/* group2 => contains starred and all starrred mapping  with active css class  */}
        <SidebarGroup>
          <SidebarGroupLabel>
        ...
        {/* group3 => contains recent  and all recent  mapping  with active css class  */}
        <SidebarGroup>
          <SidebarGroupLabel>
      ...
      {/* contains the settings sidebar fotter  */}
      <SidebarFooter>
        <SidebarMenu>
          <SidebarMenuItem>
